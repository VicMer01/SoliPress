        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedByUserId = table.Column<string>(type: "nvarchar(128)", nullable: false),
                    ApprovedByUserId = table.Column<string>(type: "nvarchar(128)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentRequests_AspNetUsers_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocumentRequests_AspNetUsers_RequestedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DocumentHistories_DocumentRequests_DocumentRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentHistories_DocumentRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentRequests_ApprovedByUserId",
